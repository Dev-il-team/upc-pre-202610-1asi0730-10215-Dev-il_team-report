...
En esta sección se presenta una guía estructurada que reúne los principales elementos visuales y de diseño utilizados en Hera, como tipografías, paleta de colores, espaciados, componentes visuales y lineamientos de interfaz. Esto permite mantener una identidad visual coherente alineada con los valores de eficiencia, seguridad, automatización e innovación.
...
La identidad visual combina colores sofisticados, contrastes equilibrados y elementos minimalistas, priorizando la claridad de la información, la facilidad de navegación y la rapidez en la toma de decisiones. El diseño evita la sobrecarga visual y se enfoca en una experiencia intuitiva y eficiente. De esta manera, Hera comunica su propósito principal: brindar control total, tranquilidad y optimización del hogar inteligente.

En cuanto a las dimensiones del tono de comunicación, Hera se posiciona como:

**Serio** (debido a la importancia de la seguridad, supervisión y control del hogar)

**Formal** (para transmitir confianza, estabilidad y profesionalismo)

**Respetuoso** (en la interacción con el usuario y el manejo de información sensible)

**Claro y orientado a la eficiencia** (priorizando simplicidad, comprensión inmediata y funcionalidad)
...
Para el logotipo y los títulos principales se utiliza la tipografía **Poppins**, debido a su estilo moderno, geométrico y profesional, ideal para transmitir innovación y tecnología. Para el contenido general, formularios, dashboards y paneles informativos se utiliza **Roboto**, ya que ofrece excelente legibilidad en pantallas digitales y una lectura fluida incluso en tamaños pequeños.
...
Además, su estilo visual aporta una identidad sofisticada y sólida, alineada con el concepto de automatización premium y control eficiente del hogar. La elección de esta tipografía también permite mantener una presencia visual fuerte sin afectar la claridad, garantizando una excelente legibilidad en distintos tamaños y dispositivos.
...
Se emplean diferentes pesos tipográficos como **Light, Regular, Medium y Bold** para organizar la información y reforzar la jerarquía visual de la interfaz. Esto facilita que el usuario identifique rápidamente elementos importantes como notificaciones, consumo energético, alertas de seguridad, estados de dispositivos y acciones principales dentro de la plataforma.
...
**Dorado (\#D4AF37):** Aporta elegancia, exclusividad y jerarquía visual. Se utiliza en botones destacados, íconos importantes y elementos de alto valor visual.
...
**Azul Claro (\#3B82F6):** Representa información general, acciones secundarias y elementos informativos dentro del sistema.

**Ámbar (\#F59E0B):** Se utiliza para advertencias moderadas o situaciones que requieren atención preventiva.
...
Este sistema facilita la distribución de los elementos dentro de dashboards, formularios, paneles de control y secciones informativas, mejorando la legibilidad y evitando la sobrecarga visual. Esto resulta fundamental en una plataforma de smart homes, donde el usuario necesita acceder rápidamente a información como seguridad, consumo energético y automatización de dispositivos.
...
Se prioriza el uso de símbolos claros relacionados con las principales funciones del sistema, como hogar inteligente, iluminación, seguridad, climatización, consumo energético, mantenimiento de piscina, control remoto y automatización.
...
Se utiliza un lenguaje sencillo y directo en acciones y notificaciones como:

“Dispositivo conectado”  
 “Consumo energético actualizado”  
...
La jerarquía visual se construye mediante el uso de tipografías bien definidas, tamaños diferenciados y una paleta de colores sofisticada basada en azul nocturno, dorado y tonos neutros, permitiendo identificar rápidamente los elementos más importantes. Los botones interactivos presentan estados visuales claros (normal, hover y activo), brindando retroalimentación inmediata al usuario.

El uso de bordes suaves, espacios equilibrados y sombras sutiles contribuye a una interfaz limpia, organizada y de apariencia premium. Asimismo, los componentes visuales mantienen consistencia en toda la plataforma, facilitando la navegación y reduciendo la curva de aprendizaje.

Finalmente, cada elemento del diseño ha sido pensado para cumplir una función práctica dentro de la experiencia del usuario, asegurando que la interfaz no solo sea atractiva, sino también eficiente, intuitiva y adaptable a diferentes dispositivos mediante principios de diseño responsive.